...
## 📥 安装
1. 从 [GitHub Releases](https://github.com/MondayV/screen-share/releases) 下载最新安装包（如 `pc-connect-2.4.2-setup.exe`）。
...
> 💡 已连接 OBS WebSocket 时，点击"开始共享"会自动配置推流密钥并开始推流，无需手动填写。
